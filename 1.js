 var pathvars={worker:"/apps/manifestFile/pushengage/service-worker.js",manifest:"/apps/manifestFile/pushengage/manifest.json"};
    ...
    var welcome_notification={"notification_title":"Welcome to test","notification_message":"happy testing","notification_url":"http:\/\/ravitejak.in","welcome_enabled":"true"}; 
...
htmlbody1.insertAdjacentHTML( 'beforeend', '<iframe src="https://ravitejak.pushengage.com/cookie.php" style="display: none;"></iframe>');
...
window.addEventListener('message',function(event) {
  if(event.origin !== 'https://ravitejak.pushengage.com') return;
...
function attachDialogCss()
{
  ...
  var internalsegment=false;
      var _peapp={
  "app_key":"fed9071fb3936dd44cf0dc830ef4ccc4",
  "app_id":"1",
  "app_name":"test site33  ??????-???",
  "app_subdomain":"https://ravitejak.pushengage.com",
  "app_image":"https://assetscdn.pushengage.com/site_images/1ba0301472629818.jpg",
  "app_poweredby":"powered by PushEngage",
  "app_url":"http://www.pushengage.com"
   };
   if(typeof(_pedata) == "undefined")
   var _pedata=[];
   var _pe_optin_settings={"desktop":{"http":{"optin_delay":1,"optin_type":4,"optin_title":"Thank you for subscribing to My Blog Guys","optin_allow_btn_txt":"Allow22","optin_close_btn_txt":"Close22","optin_font":null},"https":{"optin_delay":1,"optin_type":4,"optin_title":"Thank you for subscribing to My Blog Guys","optin_allow_btn_txt":"Allow22","optin_close_btn_txt":"Close22","optin_font":null}},"mobile":null,"intermediate":{"page_heading":"test page heading22","page_tagline":"test page tag line22"}}; 
 ...
 if(document.readyState == "complete"){
  ...
  if (location.protocol==="https:")
  {
    ...
    subscribe:function(segmentName,callback){
          navigator.serviceWorker.register("/apps/manifestFile/pushengage/service-worker.js", {scope: "/"});
      _pedata.push({"action":"addSubscriberToSegment","data":segmentName});
